<template>
  <div class="space-y-6">
    ...
    <div>
      ...
      <div class="relative">
        <span
          class="absolute top-1/2 ltr:left-0 rtl:right-0 -translate-y-1/2 ltr:border-r rtl:border-l border-gray-200 px-3.5 py-3 text-gray-500 dark:border-gray-800 dark:text-gray-400"
        >
          <svg
            width="20"
            height="20"
      ...
      <div class="relative">
        <div class="absolute ltr:left-0 rtl:right-0">
          <select
            ...
            class="appearance-none bg-none ltr:rounded-l-lg rtl:rounded-r-lg rtl:rounded-l-none border-0 ltr:border-r rtl:border-l border-gray-200 bg-transparent py-3 ltr:pl-3.5 ltr:pr-8 rtl:pr-3.5 rtl:pl-8 leading-tight text-gray-700 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-800 dark:text-gray-400"
          >
          ...
          <div
            class="absolute inset-y-0 flex items-center text-gray-700 pointer-events-none bg-none ltr:right-3 rtl:left-3 dark:text-gray-400"
          >
            <svg
      ...
      <div class="relative">
        <div class="absolute ltr:right-0 rtl:left-0">
          <select
            ...
            class="appearance-none bg-none ltr:rounded-r-lg rtl:rounded-l-lg rtl:rounded-r-none border-0 ltr:border-l rtl:border-r border-gray-200 bg-transparent py-3 ltr:pl-3.5 ltr:pr-8 rtl:pr-3.5 rtl:pl-8 leading-tight text-gray-700 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-800 dark:text-gray-400"
          >
            <option v-for="(code, country) in countryCodes" :key="country" :value="country">
              {{ country }}
            </option>
    ...
    <div>
      ...
      <div class="relative">
        ...
        <input
          v-model="url"
          type="url"
          placeholder="www.sismohidro.com"
    ...
    <div>
      ...
      <div class="relative">
        <button
          @click="copyWebsite"
          class="absolute top-1/2 ltr:right-0 rtl:left-0 inline-flex -translate-y-1/2 cursor-pointer items-center gap-1 ltr:border-l rtl:border-r border-gray-200 py-3 ltr:pl-3.5 ltr:pr-3 rtl:pr-3.5 rtl:pl-3 text-sm font-medium text-gray-700 dark:border-gray-800 dark:text-gray-400"
        >
          <svg
            class="fill-current"
            width="20"
        ...
        <input
          v-model="website"
          type="url"
          class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-3 ltr:pl-4 ltr:pr-[90px] rtl:pr-4 rtl:pl-[90px] text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
        />
      </div>
    </div>
  </div>
...
const url = ref('')
const website = ref('www.sismohidro.com')
