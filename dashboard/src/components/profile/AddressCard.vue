      ...
      <div class="flex flex-col gap-6 sm:flex-row lg:items-start lg:justify-between">
        ...
        <div>
          <button
            ...
            class="flex w-full items-center justify-center h-10 gap-2 rounded-lg border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/3 dark:hover:text-gray-200 lg:inline-flex lg:w-auto"
          >
            <svg
              class="fill-current"
              width="18"
