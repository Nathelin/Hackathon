<template>
  <div>
    <div class="mb-4 lg:mb-6 rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
      <div class="flex flex-col gap-5 sm:flex-row xl:gap-10">
        <div class="flex-1">
          <div
            class="mb-4 sm:mb-6 flex flex-col gap-5 sm:flex-row xl:items-center xl:justify-between"
          >
            <div
