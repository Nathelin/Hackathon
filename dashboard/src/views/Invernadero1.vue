<template>
  <AdminLayout>
    <h1 class="font-medium text-4xl pb-5 text-gray-800 dark:text-white/90">Invernadero 1</h1>
    <h2 class="font-medium text-4xl pb-5 text-gray-800 dark:text-white/90">Resumen de lecturas recientes.</h2>
...
const nombreInvernadero = 'Invernadero 1'
